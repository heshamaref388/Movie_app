...
export default function PopularMovie() {
  ...
  async function getTrending() {
    let { data } = await axios.get(
      `https://api.themoviedb.org/3/movie/now_playing?api_key=34d2e2cb1e0798d6b0c47746202348cb&language=en-US&page=${count}`
    );
        ...
        <div className="row mt-4">
          <div className="col-md-4 d-flex align-items-center">
            <div>
              ...
              <h2 className="h4">
                Top_rated <br /> Movies <br /> To Watch Right Now
              </h2>
